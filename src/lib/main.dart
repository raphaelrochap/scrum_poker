...
import 'package:scrum_poker/pages/CartasScrumPoker.dart';
...
void main() async {
  WidgetsFlutterBinding
      .ensureInitialized(); //Necessário para realizar as verificações em arquivos.
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      builder: (BuildContext context, Widget child) {
        return Padding(child: child, padding: EdgeInsets.only());
      },
